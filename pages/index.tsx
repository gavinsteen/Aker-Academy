    ...
    <div style={{ width: "100%", padding: "100px", alignContent: "center" }}>
      <header>
        ...
        <h4>
          ...
          <h3>Your pages:</h3>
          <ul>
            <li><Link href="/dev-ops-masterclass"><a style={{ color: "blue" }}>DevOpsAcademy - /dev-ops-masterclass</a></Link></li>
<li><Link href="/step-2-linux-administration-lessons-1-2"><a style={{ color: "blue" }}>Step2LinuxAdministrationLessons12 - /step-2-linux-administration-lessons-1-2</a></Link></li>
<li><Link href="/step-2-linux-administration-lessons-1-3"><a style={{ color: "blue" }}>Step3Project1LampStackImplementation - /step-2-linux-administration-lessons-1-3</a></Link></li>
          </ul>
